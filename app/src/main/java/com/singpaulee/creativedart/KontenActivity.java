...
public class KontenActivity extends AppCompatActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*Default for Navigation Drawer Activity */
		...
		ImageView image = (ImageView) header.findViewById(R.id.header_image2);
		Picasso.with(this)
				.load("https://unproportioned-gara.000webhostapp.com/api/creative/image/"+sharedPrefManager.getPhoto().toString())
				.into(civ);
		Toast.makeText(this, ""+sharedPrefManager.getPhoto(), Toast.LENGTH_SHORT).show();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.konten, menu);
		return true;
	}
